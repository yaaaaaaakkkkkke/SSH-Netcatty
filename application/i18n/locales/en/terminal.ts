...
export const enTerminalMessages: Messages = {
  ...
  'snippets.export.package': 'Export package',
  ...
  'snippets.import.modal.parsedSummary': '{files} file(s), {total} snippet(s), {packages} package(s), {conflicts} duplicate command(s). Host bindings are ignored.',
